  ...
  return (
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        <div className='rounded-xl border-2 border-base-content/20 overflow-hidden bg-base-100 shadow-lg max-w-lg mx-auto'>
          {/* Chat Header */}
...
// Make the border more visible by increasing its width and changing its color
export default SettingsPage

// To improve the border visibility, update the preview container's border classes:
// Replace:
...
// <div className='rounded-xl border-2 border-primary overflow-hidden bg-base-100 shadow-lg max-w-lg mx-auto'>